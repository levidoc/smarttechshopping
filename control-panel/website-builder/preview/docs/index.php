  ...
  <section class="styleguide">
    <div class="container is--medium">
      <div class="styleguide__list">
        ...
        <h4>Oops! We couldn't find the page that you're looking for.</h4>
      ...
      <div class="container is--full">
        <nav class="nav-row">
          <a href="#" onClick="history.go(-1); return false;" aria-label="home" target="_blank" class="nav-logo-row w-inline-block">
            <img src="https://cdn.varsitymarket.shop/img/favicon.png" style="width:100%; max-width:2.5rem; ">
          </a>
          <div class="nav-row__right">
            <a id="ext-dennis" href="https://varsitymarket.shop/" target="_blank" class="website-link is--alt w-inline-block">
