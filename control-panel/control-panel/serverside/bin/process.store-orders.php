...
$store_Order_data = retrieve_store_data(); 

if ($store_Order_data == null){
...
$page_ = '        
        ...
        <div class="video anim" style="--delay: .4s; margin:4rem 0px; ">
            ...
            <div class="video-view" style="padding: 10px 20px 0px;">Search For Order</div>
            <div class="video-name">
                <div class="search-bar" style="max-width: 100%; display: flex; flex-direction: row; align-content: space-between; justify-content: space-between; gap: 0.3rem; margin: 0px 0px 20px 0px;">
                    <input value="" type="text" placeholder="Order Code" id="edt_blog_username" style="background-image: none; max-width: 100%;">
                    <button>
                        Search
                    </button>
                </div>
            ...
            <div style="padding: 0px 1rem; border-radius: 2rem;">
                <table class="table-grid-application-set">
                    <thead>
                        <tr>
                            ...
                            <th class="table-Order">Order</th>
                            <th class="table-num">Items</th>
                            <th class="table-num">Price</th>
                            <th class="table-Order" style="max: width 100px;"></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="table-Order">
                                <div>
                                    <img <img src="favicon.png" style="max-width: 3rem; border-radius: 12%;">
                                    <div class="video-view" style="padding: inherit; background: inherit;">Domain</div>
                                </div>
                            </td>
                            <td class="table-num">1</td>
                            <td class="table-num">$10.00</td>
                            <td class="table-Order" style="max: width 100px;">
                            </td>
                        </tr>
                        <tr>
                            <td class="table-num">1</td>
                ...
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div class="video-view" style="padding: 0px;">Total Orders: 20</div>
                    <div>
