 ...
 */
function getGitHubOrgRepos($owner,$repo,$path, $token) {
...
$repos = getGitHubOrgRepos($owner,$repo,$path, $token);
if ($repos !== null) {
    echo json_encode($repos,JSON_PRETTY_PRINT); // Print the array of repositories
} else {
