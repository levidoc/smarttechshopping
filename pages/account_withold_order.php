...
echo (create_seo_signature('Withhold Order', '', 'SITE_OWNER', ''));
...
<div class="bg0 p-t-75 p-b-85">
    <div class="container">
        <div class="p-b-45">
            ...
            Withhold Order Payout
            </h3>
            <br><br>
            <p class="cl5 txt-center">
                To best avoid scamming, reverse any orders you have already paid for. <br>
                This would result in that particular store to not receive the funds.  <br>
                An investigation would then occur for the selected order. 
            </p>
        </div>
